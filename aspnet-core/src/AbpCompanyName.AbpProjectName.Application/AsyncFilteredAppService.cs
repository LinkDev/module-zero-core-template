...
namespace Abp.Application.Services
{
    public class AsyncFilteredAppService<TEntity, TEntityDto, TPrimaryKey, TGetAllInput> :
        AsyncFilteredAppService<TEntity, TEntityDto, TPrimaryKey, TGetAllInput, EntityDto<TPrimaryKey>, EntityDto<TPrimaryKey>, EntityDto<TPrimaryKey>, EntityDto<TPrimaryKey>>
