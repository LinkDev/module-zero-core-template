...
@Component({
    ...
    <div class="form-group">
        <mat-form-field class="full-width" [ngSwitch]="dataValue">
            <mat-select *ngSwitchCase="''" [multiple]="multiple"  [id]="id"  [placeholder]="placeholder" [(ngModel)]="value">
                <mat-option *ngFor="let item of items" [value]="item">
                    {{item[dataText]}}
                </mat-option>
            </mat-select>
            <mat-select *ngSwitchDefault [multiple]="multiple"  [id]="id"  [placeholder]="placeholder" [(ngModel)]="value">
