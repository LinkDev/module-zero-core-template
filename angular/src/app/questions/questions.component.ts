...
export class QuestionsComponent extends FilteredComponentBase<QuestionDto> {
    ...
    protected list(request: FilteredResultRequestDto, pageNumber: number, finishedCallback: Function): void {
			this._questionService.getAll(request.search, request.maxResultCount, request.sorting, request.skipCount)
				.finally(() => {
					finishedCallback();
				})
	...
	search(): void {
		...
		items.push({ FilterName: "QuestionGroupId", FilterType: FilterType.eq, FilterValue: this.questionGroupIdFilter });
