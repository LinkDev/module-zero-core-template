...
export class QuestionGroupsComponent extends FilteredComponentBase<QuestionGroupDto> {
	...
	surveyIdList: SurveyDto[] = null;
			...
			descriptionEnglishFilter: string;
	constructor(
        injector: Injector,
    ...
    protected list(request: FilteredResultRequestDto, pageNumber: number, finishedCallback: Function): void {
			this._questionGroupService.getAll(request.maxResultCount, request.skipCount ,request.search,request.sorting)
				.finally(() => {
					finishedCallback();
				})
	...
	search(): void {
        ...
        items.push({ FilterName: "Description", FilterType: FilterType.like, FilterValue: this.descriptionFilter });
						        if (this.descriptionEnglishFilter !== undefined && this.descriptionEnglishFilter !== null && this.descriptionEnglishFilter.toString() !== '')
        items.push({ FilterName: "DescriptionEnglish", FilterType: FilterType.like, FilterValue: this.descriptionEnglishFilter });
